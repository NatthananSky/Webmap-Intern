(function () {
    ...
    L.Control.LinearMeasurement = L.Control.extend({
        ...
        onAdd: function (map) {
            ...
            var icon = L.DomUtil.create('i', 'bx bx-ruler', link);
            $(icon).css({
                'line-height': '30px',
                'font-size': '25px',
                'opacity': '0.8',
